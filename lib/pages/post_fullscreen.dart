...
class _PostFullscreenState extends State<PostFullscreen> {
  ...
  getSinger() async {
    if (Constants.starUser != null && Constants.starUser!.id != null) {
  ...
  getMelody() async {
    if (_record != null && _record!.melodyId != null) {
    ...
    if (_melody != null && _melody!.singer != null) {
  ...
  void initState() {
    ...
    if (widget.record != null) {
      ...
      if (_news!.id != null) DatabaseService.incrementNewsViews(_news!.id!);
    }
    if (_record != null && _record!.url != null)
      initVideoPlayer(_record!.url!);
    else if (_record?.url == null && _news != null && _news!.contentUrl != null)
  ...
  late Record _nextRecord, _previousRecord;
  late News _nextNews, _previousNews;
  late DragStartDetails startVerticalDragDetails;
  late DragUpdateDetails updateVerticalDragDetails;

  Future<bool> _onBackPressed() async {
    print(Constants.currentRoute);
    if (widget.news != null) {
                ...
                ? SimpleGestureDetector(
                    ...
                    child: PageView.builder(
                        ...
                        onPageChanged: (index) async {
                          ...
                          else if (_news != null) pageChangedNews(index);
                        },
  ...
  pageChangedRecord(int index) async {
    ...
    setState(() {
      _record = record;
      if (next != null) _nextRecord = next;
      if (previous != null) _previousRecord = previous;
    });

    if (_record != null && _record!.id != null)
      DatabaseService.incrementRecordViews(_record!.id!);
    if (_record != null && _record!.url != null) initVideoPlayer(_record!.url!);
    getMelody();
    getSinger();
    isFollowing();
    initLikes(record: _record, news: _news);
  ...
  pageChangedNews(int index) async {
    ...
    if (_news != null && _news!.timestamp != null) {
      if (index > _page) {
    ...
    if (_news != null && _news!.id != null)
      DatabaseService.incrementNewsViews(_news!.id!);
    if (_news != null && _news!.contentUrl != null)
      initVideoPlayer(_news!.contentUrl!);
    getSinger();
